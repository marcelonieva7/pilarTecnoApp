...
const CenterCreate = props => {
  ...
  const onSubmit = ({ name, adress, img, lat, lon }) => {
    ...
    Alert.alert('Alerta', 'Crear centro?', [
      {
        text: 'Crear',
        onPress: () => {
          props
            ...
            .then(() => Alert.alert('Alerta', 'Centro Creado'))
...
const mapDispatchToProps = dispatch => ({
  createCenter: data => dispatch(actions.centers.createCenter(data)),
});

const mapStateToProps = state => ({});

export default connect(mapStateToProps, mapDispatchToProps)(CenterCreate);
